...
class ProjectBrowser(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        if sys.platform == 'win32':
            self.ProjectsPath = "e:\\!Projects"  # Windows
        elif sys.platform == 'linux' or 'linux2':
            self.ProjectsPath = "/media/sf_!Projects"  # Linux

        print("Initial ProjectsPath: {}".format(self.ProjectsPath))
    ...
    def confirmNewProject(self, dialog, project_name):
        ...
        try:
            ...
            QMessageBox.warning(self, "Directory Creation Failed", "Failed to create project directory or subfolders")
            return
    ...
    def ensure_directory_exists(self, directory):
        if not os.path.exists(directory):
            try:
                ...
                QMessageBox.warning(self, "Directory Creation Failed", "Failed to create directory")
                return False
        return True
    ...
    def createTemplateScript(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Save Failed", "Failed to save template script")
    ...
    def openFileExplorer(self):
        ...
        if os.path.exists(project_folder):
            ...
            QMessageBox.warning(self, "Directory Not Found", "The project directory does not exist.")
    ...
    def refresh(self):
        ...
        if os.path.exists(self.ProjectsPath):
            ...
            QMessageBox.warning(self, "Directory Not Found", "The projects directory does not exist.")
    ...
    def scriptSelected(self, index):
        ...
        if os.path.exists(selected_script_path):
            ...
            self.selected_script_path = ""
            QMessageBox.warning(self, "Script Not Found", "The script does not exist.")
    ...
    def createNewScript(self, shot_name, task, assignment, version_str, dialog):
        ...
        while True:
	    script_name = "{}_{}_{}_v{:03d}.nk".format(shot_name, task, assignment, version)
        ...
        try:
            ...
            QMessageBox.warning(self, "Creation Failed", "Failed to create script")
        finally:
            dialog.accept()
    ...
    def openScript(self):
        if os.path.exists(self.selected_script_path):
            ...
            QMessageBox.warning(self, "Script Not Found", "The selected script does not exist.")
    ...
    def versionScript(self):
        ...
        new_script_name = "{}_v{:03d}{}".format(base_name, new_version, ext)
        ...
        try:
            ...
            QMessageBox.warning(self, "Copy Failed", "Failed to copy script")
            return
